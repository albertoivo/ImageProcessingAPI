...
describe('GET /resize (Bad Request)', () => {
  it('responds with 400 (Bad Request - Width or Height = 0)', (done) => {
    request(app)
      .get('/resize?fileInput=sunset.jpg&width=0&height=66&method=contain')
      .expect(400, done)
  })

  it('responds with 400 (Bad Request - Width or Height Not a Number)', (done) => {
    request(app)
      .get('/resize?fileInput=sunset.jpg&width=AAA&height=66&method=contain')
      .expect(400, done)
  })

  it('responds with 400 (Bad Request - Width or Height less then 1)', (done) => {
    request(app)
      .get('/resize?fileInput=sunset.jpg&width=-66&height=66&method=contain')
      .expect(400, done)
  })

  it('responds with 400 (Bad Request - Neither Width nor Height)', (done) => {
    request(app)
      .get('/resize?fileInput=sunset.jpg&method=contain')
      .expect(400, done)
  })
